                ...
                if (tools.isArray(sNodes)) {
                    ...
                    for (i = 0, l = sNodes.length; i < l; i++) {
                        ...
                        if (typeof parentKey === 'string') {
                            parentValue = sNodes[i];
                            var props = parentKey.split('.');
                            for (var j = 0; j < props.length; j++) {
                                if (parentValue[props[j]] !== null) {
                                    parentValue = parentValue[props[j]];
                                }
                            }
                        } else {
                            parentValue = sNodes[i][parentKey];
                        }
                        var p = tmpMap[parentValue];
                        if (p && sNodes[i][key] != parentValue) {
